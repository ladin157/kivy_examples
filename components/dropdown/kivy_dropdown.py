...
if __name__ == '__main__':
    ...
    # txtInput = TextInput(text='This is test', size_hint = (0.3, 0.05), pos=(300, 300))
    btn = Button(text='SHOW', size_hint=(None, None), pos=(300, 200))
    btn.bind(on_release=show_dropdown, on_touch_move=touch_move)
    # txtInput.bind(on_touch_down=show_dropdown) #, on_touch_move=touch_move)
    runTouchApp(btn)
    # runTouchApp(txtInput)
